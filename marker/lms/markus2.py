'''
Utilities related to interfacing with MarkUs version 2
...
class Markus2(LMS):
    ...
    @cached_property
    def mapping(self):
        url = f'{self.base_url}/api/courses/{self.course_id}/assignments/{self.assgn_id}/groups.json'
    ...
    def assgn_id(self):
        ...
        '''
        url = f'{self.base_url}/api/courses/{self.course_id}/assignments.json'
        response = requests.get(url, headers=self.header)
        if response.status_code >= 400:
   ...
   # -------------------------------------------------------------------------
    ...
    async def _get_ffs(self, session, group_id):
        ...
        the form:
                         { filename : file_id }
        '''
        url = f'{self.base_url}/api/courses/{self.course_id}/assignments/{self.assgn_id}/groups/{group_id}/feedback_files.json'
    ...
    async def delete_report(self, session, student):
        ...
        for _, rid in feedback_files.items():
            url = f'{self.base_url}/api/courses/{self.course_id}/assignments/{self.assgn_id}/groups/{group_id}/feedback_files/{rid}.json'
    ...
    async def upload_report(self, session, student):
        ...
        if fname in existing_ffs:
            url = f'{self.base_url}/api/courses/{self.course_id}/assignments/{self.assgn_id}/groups/{group_id}/feedback_files/{existing_ffs[fname]}.json'
    ...
    async def upload_mark(self, session, student, mark_list):
        ...
        url = f'{self.base_url}/api/courses/{self.course_id}/assignments/{self.assgn_id}/groups/{group_id}/update_marks.json'
    ...
    async def set_status(self, session, student, status):
        ...
        url = f'{self.base_url}/api/courses/{self.course_id}/assignments/{self.assgn_id}/groups/{group_id}/update_marking_state.json'
